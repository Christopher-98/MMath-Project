...
# Modeling - North Sea whales

Having shown that the model performs adequatly with a complex study region, its performance in comparison to a real world study will be tested. This will be on the same study region as previously, however with a different density distribution to reflect the studies done on whales in the region in both 1994 and 2005 (insert studies info). 
