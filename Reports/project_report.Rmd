...
- improve variance estimators within DS by allowing more to work with current simulations
- further simulation investigates with covariates in both detection and spatial model
- improve model checking process within simulation / computational cost
- covariates varying at below segment scale
