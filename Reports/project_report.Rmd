...
With truth being in the 95% CI  times out of 1000, we can conclude that the model is particularly good and containing truth within its estimated confidence interval. However, this could be due the the variance in each model being quite large resulting in wide confidence intervals. 
...
With truth being in the 95% CI  times out of 1000, we can conclude that the model is particularly good and containing truth within its estimated confidence interval. However, this could again be due the the variance in each model being quite large resulting in wide confidence intervals. 
...
kable(results)
#%>%
 # add_header_above(c('Statistic' = 1, 'Point Design' = 2, 'Line design' = 2))
