...
```
As with each of the simulations run as part of the North Sea section, 5000 simulations will be run for each design. While this is different from the 100 simulations originally conducted, the increase in the number of simulations will increase the reliability of the results.
